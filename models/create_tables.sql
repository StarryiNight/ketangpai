...
INSERT INTO `post` VALUES (11, 371965671409451009, '9.10作业', '英语听力p110 ', 371032570705477633, 1, 1, '2021-09-10 09:46:57', '2021-09-10 09:46:57');
...
-- Records of score
-- ----------------------------
INSERT INTO `score` VALUES (23, 371133821019488257, NULL);
...
CREATE TABLE `user`  (
  ...
  `position` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
INSERT INTO `user` VALUES (4, 371133821019488257, '小明', '31323334353678f5ef94a851cd855e9e4eabd80d5956', NULL, 0, '2021-09-04 16:03:15', '2021-09-12 14:18:29', 'student');
